 ...
 *
 * Note: this repo's existing "cancellation" path always refunds money, even though
 * the order has not been fulfilled yet. There is no separate pre-payment void path.
 */
