...
| [`shepherd`](skills/shepherd/SKILL.md) | Orchestrates end-to-end autonomous builds across gated spec, standards, evidence readiness, planning, implementation, refactor, architect hardening, and implementer repair cycles. It keeps normal acceptance pipeline work with implementers and mutation hardening with architects. |
