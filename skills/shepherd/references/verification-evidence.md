...
| Acceptance-spec mutation | passing mutation verdict from `validate_acceptance_mutation.py` plus the kit report (`survived=0`, `errors=0`, `total>0`) | passing normal acceptance alone, a summary block without results, or a hand-written verdict |
