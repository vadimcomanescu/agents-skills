...
10. For an AC whose proof modality is `acceptance-spec mutation`, require a passing kit report (exit 0, `survived=0`, `errors=0`, `total>0`); passing normal acceptance is candidate evidence only.
