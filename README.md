...
| [`shepherd`](skills/shepherd/SKILL.md) | Orchestrates end-to-end autonomous builds across gated intent, spec, standards, planning, implementation, refactor, architect hardening, and implementer repair cycles. It uses repo-defined verification commands and does not invent verification infrastructure. |
