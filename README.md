...
| [`shepherd`](skills/shepherd/SKILL.md) | Orchestrates end-to-end autonomous builds across spec, standards, reviewed planning, implementation, refactor, architect hardening, and implementer repair cycles. Standards include a skill relevance pass so planning uses relevant project skills without importing generic advice. |
