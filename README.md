...
| [`arianna-magic`](skills/arianna-magic/SKILL.md) (+ 8 role skills) | Long-running autonomous build pipeline. Slash-command entry `/arianna-magic <goal>` classifies intent, dispatches role-specialist subagents (`arianna-research`, `arianna-spec`, `arianna-design`, `arianna-plan`, `arianna-implement`, `arianna-review`, `arianna-critique`, `arianna-grill`), and renders a Birchline-styled dashboard at `.agent/dashboard.html`. |
